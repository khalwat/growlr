<template>
  <div class="flex justify-center p-6">
    <button
      class="w-10 h-10 rounded-full bg-blue-500 hover:bg-blue-800 flex items-center justify-center text-white text-xl font-bold dark:bg-blue-600 dark:hover:bg-blue-700"
      type="button"
      @click="handleClick">
      ?
    </button>
